...
async def status_task():
    while True:
        await client.change_presence(game=discord.Game(name='for JoJo'))
...
async def on_reaction_add(reaction, user):
  if reaction.message.server is None:
      if reaction.emoji == '🇬':
        ...
        embed.add_field(name = 'm!rolldice',value ='Use it like ``m!rolldice <1-6 any number that you want to guess in dice>``',inline = False)
        embed.add_field(name = 'm!avatar',value ='Use it like ``m!avatar or mv!avatar @user``',inline = False)
        embed.add_field(name = 'm!ping',value ='Use it to check ping of bot',inline = False)
        embed.add_field(name = 'm!flipcoin',value ='Use it like ``m!rolldice <Your prediction>`` prediction = heads, tails or coin self destructed)``',inline = False)
        embed.add_field(name = 'm!enterme',value ='Use it like ``m!enterme <giveaway channel>`` to enter in a giveaway running in a particular channel',inline = False)
        ...
        embed.add_field(name = 'm!github ',value ='Use it like- ``m!github uksoftworld/DarkBot``',inline = False)
        embed.add_field(name = 'm!bottutorial ',value ='Use it like ``m!bottutorial <tutorial name by darklegend>``',inline = False)
        embed.add_field(name = 'm!dyno ',value ='Use it like ``m!dyno <dyno command name>``',inline = False)
      ...
      if reaction.emoji == '🇲':
        ...
        embed.add_field(name = 'm!partner(Admin permission required) (Cooldown of 12hours)',value ='Use it like ``m!partner <partnership description>`` to partner with many servers with are connected with MultiVerse Official bot',inline = False)
        embed.add_field(name = 'm!dm(Admin permission required) ',value ='Use it like ``m!dm @user <text>`` to dm user from bot',inline = False)
        embed.add_field(name = 'm!say(Admin permission required) ',value ='Use it like ``m!say <text>``',inline = False)
        ...
        embed.add_field(name = 'm!embed(Admin permission required) ',value ='Use it like ``m!embed <text>``',inline = False)
        embed.add_field(name = 'm!membercount(Kick members Permission Required) ',value ='Use it like ``m!membercount`` to get membercount',inline = False)
        embed.add_field(name = 'm!removemod(Admin Permission Required)',value ='Use it like ``m!removemod @user`` to remove him from mod. Note-You need Moderator role in your server below bot to use it.',inline = False)
        embed.add_field(name = 'm!makemod(Admin Permission Required)',value ='Use it like ``m!makemod @user`` to make him mod. Note-You need Moderator role in your server below darkbot to use it.',inline = False)
        embed.add_field(name = 'm!friend(Admin Permission Required) ',value ='Use it like ``m!friend @user`` to give anyone Friend of Owner role',inline = False)
        embed.add_field(name = 'm!role(Manage Roles Permission Required)',value ='Use it like ``m!role @user <rolename>``.',inline = False)
        embed.add_field(name = 'm!setnick(Manage nickname permission required)',value ='Use it like ``m!setnick @user <New nickname>`` to change the nickname of tagged user.',inline = False)
        embed.add_field(name = 'm!english(Kick members Permission Required)',value ='Use it like ``m!english @user`` when someone speaks languages other than English.',inline = False)
        embed.add_field(name = 'm!serverinfo(Kick members Permission Required) ',value ='Use it like ``m!serverinfo`` to get server info',inline = False)
        embed.add_field(name = 'm!userinfo(Kick members Permission Required) ',value ='Use it like ``m!userinfo @user`` to get some basic info of tagged user',inline = False)
      ...
      if reaction.emoji == '⏭':
        ...
        embed.set_author(name='Moderation Commands Help')
        embed.set_image(url = 'https://image.ibb.co/caM2BK/help.gif')
        embed.add_field(name = 'm!unbanall(Unban members Permission Required)',value ='Use it like ``m!unbanall`` to unban all members',inline = False)
        embed.add_field(name = 'm!kick(Kick members Permission Required)',value ='Use it like ``m!kick @user`` to kick any user',inline = False)
        embed.add_field(name = 'm!muteinchannel(Ban members Permission Required)',value ='Use it like ``m!muteinchannel @user <time in minutes>`` Example- ``mv!muteinchannel @user 1`` to mute user for 1min.',inline = False)
        embed.add_field(name = 'm!unmuteinchannel(Ban members Permission Required)',value ='Use it like ``m!unmuteinchannel @user`` to unmute user from that channel.',inline = False)
        ...
        embed.add_field(name = 'm!norole(Kick members Permission Required) ',value ='Use it like ``m!norole @user`` to warn anyone if he/she asks for promotion',inline = False)
        embed.add_field(name = 'm!getuser(Kick members Permission Required) ',value ='Use it like ``m!getuser @rolename`` to get list of all users having a particular role',inline = False)
        react_message = await client.send_message(user,embed=embed)
        reaction = '⏮'
        await client.add_reaction(react_message, reaction)
      ...
      if reaction.emoji == '⏮':
        ...
        embed.set_author(name='Moderation Commands Help')
        embed.set_image(url = 'https://image.ibb.co/caM2BK/help.gif')
        embed.add_field(name = 'm!announce(Admin Permission required) ',value ='To make bot announce anything using ``m!announce <channel> <msg>``. Note- It does not annoy people by tagging everyone or here.',inline = False)
        embed.add_field(name = 'm!say(Admin permission required) ',value ='Use it like ``m!say <text>``',inline = False)
        embed.add_field(name = 'm!embed(Admin permission required) ',value ='Use it like ``m!embed <text>``',inline = False)
        embed.add_field(name = 'm!membercount(Kick members Permission Required) ',value ='Use it like ``m!membercount`` to get membercount',inline = False)
        embed.add_field(name = 'm!removemod(Admin Permission Required)',value ='Use it like ``m!removemod @user`` to remove him from mod. Note-You need Moderator role in your server below bot to use it.',inline = False)
      ...
      if reaction.emoji == '🏵':
        ...
        embed.add_field(name = 'Setting up Multiverse bot log(Admin Permission required) ',value ='Use ``m!setuplog`` and it will automatically add a log channel and log all stuffs there.',inline = False)
        await client.send_message(user,embed=embed)
